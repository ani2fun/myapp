...
import org.tiger.CoffeeShop.MongoClientManager;
...
public class App extends Application<AppConfiguration> {
    ...
    public void run(final AppConfiguration configuration, final Environment environment) throws Exception {
        ...
        MongoClientURI  mongoClientURI = new MongoClientURI(System.getenv("MONGOLAB_URI") != null ? System.getenv("MONGOLAB_URI") : "mongodb://127.0.0.1:27017/");
        ...
        MongoClient        mongoClient = new MongoClient(mongoClientURI);   // Add MongoLabURL for heroku deployment
                        ...
                        environment.jersey().register(new FeedbackResource(mongoClient));
                        environment.jersey().register(new DishResource(mongoClient));   // it's inside Menu Package
                        environment.jersey().register(new PromotionResource(mongoClient));
                        environment.jersey().register(new LeadershipResource(mongoClient));
...
// mongodb://heroku_q29582ps:5cvfqqappp0q9p27ljvr5f9kjo@ds013908.mongolab.com:13908/heroku_q29582ps
